...
# 4 Get the total number of avocado documents in the collection
...
# 5 Get all avocado documents from the 'avocados' collection
...
# 6 Get a single document by its unique index from the avocados collection
...
# 7 Add a new avocado entry with a POST request
...
# 8 Get avocado entries by region
...
# 9 Get avocados for a specific season
...
# 10 Get avocado entries within a specific date range
...
# 11 Get the average size bags for a specific region
...
# 12 Get the count of avocados with a specific small PLU code
...
# 13 Get avocado documents by state
...
# 14 Get the count of avocado documents for a specific season and region
